 ...
 *                   Eduardo Ramalho;
 *
 * $Id: XYPlot.java,v 1.44.2.19 2007/02/07 16:31:49 mungady Exp $
 *
...
public class XYPlot extends Plot implements ValueAxisPlot,
    ...
    public void draw(Graphics2D g2,
        ...
        if (anchor != null) {
            ...
            if (domainAxis != null) {
                double x = domainAxis.java2DToValue(anchor.getX(), dataArea, 
                        getDomainAxisEdge());
                crosshairState.setAnchorX(x);
            }
            ValueAxis rangeAxis = getRangeAxis();
            if (rangeAxis != null) {
                double y = rangeAxis.java2DToValue(anchor.getY(), dataArea, 
                        getRangeAxisEdge());
        ...
        ValueAxis xAxis = getDomainAxis(crosshairState.getDomainAxisIndex());
        if (!this.domainCrosshairLockedOnData && anchor != null) {
            double xx = xAxis.java2DToValue(anchor.getX(), dataArea,
                    getDomainAxisEdge());
        ...
        ValueAxis yAxis = getRangeAxis(crosshairState.getRangeAxisIndex());
        if (!this.rangeCrosshairLockedOnData && anchor != null) {
            double yy = yAxis.java2DToValue(anchor.getY(), dataArea, 
                    getRangeAxisEdge());
